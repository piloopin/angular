...
export class NumberPipe extends Pipe {
  _format(value: number, style: NumberFormatStyle, digits: string, currency: string = null,
...
export class DecimalPipe extends NumberPipe {
  transform(value, digits: string = null) {
    return this._format(value, NumberFormatStyle.DECIMAL, digits);
  }
}
...
export class PercentPipe extends NumberPipe {
  transform(value, digits: string = null) {
    return this._format(value, NumberFormatStyle.PERCENT, digits);
  }
}
...
export class CurrencyPipe extends NumberPipe {
  transform(value, currencyCode: string = 'USD', symbolDisplay: boolean = false,
            digits: string = null) {
    return this._format(value, NumberFormatStyle.CURRENCY, digits, currencyCode, symbolDisplay);
  }
}

export class NumberPipeFactory implements PipeFactory {
  constructor(private _pipe: NumberPipe) {}
